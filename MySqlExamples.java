...
public class MySqlExamples {
	...
	public static void select() {
		...
		String hostName = "134.209.169.96"; // server address + port number
		String dbName = "test"; // default database name
		String dbUserName = "is2710practice"; // login name for the database server
		String dbPassword = "!s2710Pra6t1c3"; // password for the database server
